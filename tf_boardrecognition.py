# board recognition with tensorflow
# Imports for visualization
# https://github.com/Elucidation/tensorflow_chessbot/blob/master/tensorflow_compvision.ipynb
# shamelessly stolen because i could not reproduce some steps in opencv
import PIL.Image
...
def display_array(a, fmt='png', rng=[0,1]):
...
# splitting board into quadratic tiles
